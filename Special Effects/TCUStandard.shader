...
// Force reimport: 2
Shader "AtlasShaders/TCUStandard"
{
	Properties
	{
		...
		_Parallax2("Parallax Iterations", Float) = 0
		_Parallax("Height Scale", Float) = 0
		_Parallax3("Parallax Refence Plane", Float) = 0
		...
		[Header(Emission Overlay)][NoScaleOffset][SingleLineTexture]_TopograpicalLines("Topograpical Lines", 2D) = "white" {}
		[HDR]_TopograpicalOverlayColor("Topograpical Overlay Color", Color) = (0.8705882,0.8705882,0.8705882,1)
		_TopograpicalOverlayTimeScale("Topograpical Overlay Time Scale", Float) = 1
		_TopograpicalOverlayTiliing("Topograpical Overlay Tiliing", Vector) = (1,1,0,0)
		_TopograpicalOverlayOffset("Topograpical Overlay Offset", Vector) = (0.05,0,0,0)
		_TopograpicalDistortOverlay("Topograpical Distort Overlay", Float) = 1
		[Header(Flowmap)][NoScaleOffset][SingleLineTexture]_Flowmap("Flowmap", 2D) = "white" {}
		_FlowmapDistortOverlay("Flowmap Distort Overlay", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			CBUFFER_START(UnityPerMaterial)
				...
				float _TopograpicalOverlayTimeScale;
				...
				float _Parallax3;
				float _Parallax2;
				float _TopograpicalDistortOverlay;
				float _Cull;
				//float4 _BaseMap_ST;
				//half4 _BaseColor;
			...
			sampler2D _Flowmap;
			sampler2D _TopograpicalLines;
			sampler2D _MetallicGlossMap;
			sampler2D _OcclusionMap;

			
			float2 IterativeParallax27_g147( sampler2D tex, float2 UVs, float2 plane, int ite, float refp, float scale, SamplerState customSS )
			{
				...
				) : SV_Target
			{
				...
				float2 appendResult2_g147 = (float2(ase_tanViewDir.xy));
				float2 temp_output_4_0_g147 = ( appendResult2_g147 / ase_tanViewDir.z );
				float2 plane27_g147 = temp_output_4_0_g147;
				int temp_output_25_0_g147 = (int)_Parallax2;
				int ite27_g147 = temp_output_25_0_g147;
				float temp_output_10_0_g147 = _Parallax3;
				float refp27_g147 = temp_output_10_0_g147;
				float temp_output_9_0_g147 = ( _Parallax * -1.0 );
				float scale27_g147 = temp_output_9_0_g147;
				SamplerState customSS27_g147 = sampler_ParallaxMap;
				float2 localIterativeParallax27_g147 = IterativeParallax27_g147( tex27_g147 , UVs27_g147 , plane27_g147 , ite27_g147 , refp27_g147 , scale27_g147 , customSS27_g147 );
				float2 temp_output_589_0 = localIterativeParallax27_g147;
				float2 UV_Main492 = temp_output_589_0;
				...
				float4 DetailAlbedoUV499 = ( ( ( float4( temp_output_589_0, 0.0 , 0.0 ) - uvs4_MainTex ) * float4( localReturnDetailAlbedo446, 0.0 , 0.0 ) ) + uvs4_DetailAlbedoMap );
				...
				float2 texCoord569 = i.uv0XY_bitZ_fog.xy * _FlowmapTiliing + _FlowmapOverlayOffset;
				float4 tex2DNode563 = tex2D( _Flowmap, texCoord569 );
				float mulTime574 = _TimeParameters.x * _TopograpicalOverlayTimeScale;
				float2 texCoord576 = i.uv0XY_bitZ_fog.xy * _TopograpicalOverlayTiliing + ( _TopograpicalOverlayOffset * mulTime574 );
				float4 EmissionMap540 = ( tex2D( _EmissionMap, UV_Main492 ) * ( ( _EmissionOverlayColor * tex2D( _EmissionOverlay, ( float4( texCoord555, 0.0 , 0.0 ) + ( _FlowmapDistortOverlay * tex2DNode563 ) + float4( UV_Main492, 0.0 , 0.0 ) ).rg ) ) + ( tex2D( _TopograpicalLines, ( float4( texCoord576, 0.0 , 0.0 ) + ( _TopograpicalDistortOverlay * tex2DNode563 ) ).rg ) * _TopograpicalOverlayColor ) ) );
		...
		Pass
		{
			...
			half4 frag(v2f i  ) : SV_Target
			{
				...
				float2 texCoord569 = i.uv * _FlowmapTiliing + _FlowmapOverlayOffset;
				float4 tex2DNode563 = tex2D( _Flowmap, texCoord569 );
				float mulTime574 = _TimeParameters.x * _TopograpicalOverlayTimeScale;
				float2 texCoord576 = i.uv * _TopograpicalOverlayTiliing + ( _TopograpicalOverlayOffset * mulTime574 );
				float4 EmissionMap540 = ( tex2D( _EmissionMap, UV_Main492 ) * ( ( _EmissionOverlayColor * tex2D( _EmissionOverlay, ( float4( texCoord555, 0.0 , 0.0 ) + ( _FlowmapDistortOverlay * tex2DNode563 ) + float4( UV_Main492, 0.0 , 0.0 ) ).rg ) ) + ( tex2D( _TopograpicalLines, ( float4( texCoord576, 0.0 , 0.0 ) + ( _TopograpicalDistortOverlay * tex2DNode563 ) ).rg ) * _TopograpicalOverlayColor ) ) );
				float4 EmissionColor540 = _EmissionColor;
				float4 Colorshiftbool514 = staticSwitch293;
				float4 Albedo540 = Colorshiftbool514;
...
/*ASEBEGIN
Version=19102
Node;AmplifyShaderEditor.CommentaryNode;209;-3740.167,590.5229;Inherit;False;1877.917;1251.541;;17;165;447;445;164;446;444;492;155;434;148;154;120;499;533;589;606;607;Height Map;1,0.9924703,0,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;283;-2948.931,-2267.301;Float;False;Property;_ColorShift3;_ColorShift3;57;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;281;-2947.631,-2435.001;Float;False;Property;_ColorShift2;_ColorShift2;56;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;296;-2315.782,-898.0261;Inherit;False;Property;_VertexTint;Vertex Tint;58;0;Create;False;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;285;-2947.629,-2600.101;Float;False;Property;_ColorShift1;_ColorShift1;55;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;282;-2948.264,-2809.055;Inherit;True;Property;_ColorMask;Color Tint;54;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;False;1;Color Mask;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;293;-1037.225,-967.9062;Inherit;False;Property;_UseColorMask;Use ColorMask;62;0;Create;False;0;0;0;False;0;False;0;0;0;True;_COLORSHIFT;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;469;-1469.095,359.0738;Inherit;False;Property;_Cull;cull;63;1;[HideInInspector];Create;False;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;305;-2194.06,-368.1313;Inherit;False;Property;VertexIllumination;VertexIllumination;59;0;Create;False;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;769.862,-271.0169;Inherit;True;Property;_DetailMask;Detail Mask;40;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Detail;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;204;-849.5566,-3319.971;Inherit;False;2953.882;1530.191;;45;568;567;573;572;570;577;566;576;555;571;560;558;557;556;559;563;553;542;561;493;569;565;564;116;515;562;110;554;482;484;541;435;436;540;543;545;544;391;574;575;584;583;585;586;587;Emission;1,0.4206045,0,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;179;809.2394,-419.44;Inherit;False;Detail Albedo;41;;145;29e5a290b15a7884983e27c8f1afaa8c;0;3;12;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;9;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;484;1782,-2580.813;Inherit;False;Emission;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;482;1573.071,-2580.209;Inherit;False;BakedEmission;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ColorNode;190;-40.2145,-4356.368;Inherit;False;Property;_Absorbance;Absorbance;53;0;Create;True;0;0;0;False;0;False;0.5882353,0.7843137,0.8666667,0;0.09999994,0.25,0.5,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;186;-1043.968,-4667.94;Inherit;False;Property;_FluoresenceTint;Fluoresence Tint;50;1;[Header];Create;True;1;Fluoresence;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;504;-783.4122,16.60778;Inherit;False;Property;_Float0;Metallic;60;0;Fetch;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;497;-1496.462,83.33146;Inherit;False;492;UV_Main;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;183;-1007.251,-4922.509;Inherit;True;Property;_FluoresenceMap;Fluoresence Map;51;2;[Header];[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;100;515.1421,289.3925;Inherit;False;Property;_DetailNormalMapScale;Detail Normal Scale;48;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;99;781.5314,137.8232;Inherit;True;Property;_DetailNormalMap;Detail Normal;47;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;27;-990.0897,1505.002;Inherit;True;Property;_OcclusionMap;Occlusion Map;37;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Occlusion;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;82;-3.784993,799.3622;Inherit;False;Property;_UseOcclusion;Use Occlusion;38;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;184;-1039.949,-4450.524;Inherit;False;Property;_Intensity;Intensity;52;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;300;-1.340688,914.0103;Inherit;False;Property;_VertexOcclusion;Vertex Occlusion;61;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;547;113.2767,-59.96434;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;14;AtlasShaders/TCUStandard;623634af11bd9ab448550ee777f3493e;True;Forward;0;0;Forward;14;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_Cull;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;Lightmode=UniversalForward;True;7;False;0;Hidden/InternalErrorShader;0;0;Standard;24;Workflow;1;0;Surface;0;0;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;0;0;Built-in Fog;1;0;Lightmaps;1;0;Volumetrics;1;0;Decals;0;0;Write Depth;0;0;  Early Z (broken);0;0;Vertex Position,InvertActionOnDeselection;1;0;Emission;1;0;PC Reflection Probe;3;0;PC Receive Shadows;1;0;PC Vertex Lights;0;0;PC SSAO;1;0;Q Reflection Probe;0;0;Q Receive Shadows;0;0;Q Vertex Lights;1;0;Q SSAO;0;0;Environment Reflections;1;0;Meta Pass;1;0;0;5;True;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.StaticSwitch;538;-1041.366,-597.6456;Inherit;False;Property;_UseDetail;Use Detail;39;0;Create;False;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;172;424.3585,945.859;Inherit;False;Property;_OcclusionStrength;_OcclusionStrength;49;0;Create;True;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;554;988.1159,-3127.252;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;110;626.3299,-3188.557;Inherit;True;Property;_EmissionMap;Emission Map;17;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Emission;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;569;-192.0958,-2428.484;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;493;326.2593,-3241.643;Inherit;False;492;UV_Main;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;494;-3038.728,-1200.858;Inherit;False;492;UV_Main;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;553;622.7018,-2994.797;Inherit;True;Property;_EmissionOverlay;Emission Overlay;21;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Emission Overlay;0;0;False;0;False;-1;80cb9145056afff4997271b329ca1c2c;80cb9145056afff4997271b329ca1c2c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;559;198.1161,-2931.251;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;556;79.11607,-3146.252;Inherit;False;Property;_EmissionOverlayTiliing;Emission Overlay Tiliing;24;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;557;-58.8847,-2986.252;Inherit;False;Property;_EmissionOverlayOffset;Emission Overlay Offset;25;0;Create;True;0;0;0;False;0;False;0.05,0;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;558;17.56096,-2820.323;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;560;-267.8849,-2736.251;Inherit;False;Property;_EmissionOverlayTimeScale;Emission Overlay Time Scale;23;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;555;349.1844,-3049.679;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;566;435.256,-2848.01;Inherit;False;3;3;0;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT2;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;567;-403.054,-2491.614;Inherit;False;Property;_FlowmapTiliing;Flowmap  Tiliing;34;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;568;-429.9749,-2349.625;Inherit;False;Property;_FlowmapOverlayOffset;Flowmap Overlay Offset;35;0;Create;True;0;0;0;False;0;False;0.05,0;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;574;-224.2659,-1944.859;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;575;-549.7113,-1944.787;Inherit;False;Property;_TopograpicalOverlayTimeScale;Topograpical Overlay Time Scale;28;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;573;-383.0185,-2091.728;Inherit;False;Property;_TopograpicalOverlayOffset;Topograpical Overlay Offset;30;0;Create;True;0;0;0;False;0;False;0.05,0;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;572;-396.2485,-2226.033;Inherit;False;Property;_TopograpicalOverlayTiliing;Topograpical Overlay Tiliing;29;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;576;82.91589,-2231.953;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;577;302.2411,-2243.434;Inherit;False;2;2;0;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;571;-22.05791,-2089.262;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;570;435.1109,-2342.254;Inherit;True;Property;_TopograpicalLines;Topograpical Lines;26;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Emission Overlay;0;0;False;0;False;-1;80cb9145056afff4997271b329ca1c2c;80cb9145056afff4997271b329ca1c2c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;391;1129.272,-2652.342;Inherit;False;Property;_EmitAlbedo;Emit Albedo;36;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;436;1199.579,-2495.871;Inherit;False;Property;_BakedMutiplier;Emission Baked Multiplier;20;0;Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;515;927.1651,-2437.363;Inherit;False;514;Colorshiftbool;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;116;941.7481,-2814.796;Inherit;False;Property;_EmissionColor;Emission Color;18;1;[HDR];Create;True;0;0;0;True;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;542;931.662,-2359.997;Inherit;False;488;AlbedoDetails;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;561;877.9008,-2628.103;Inherit;False;Property;_EmissionOverlayColor;Emission Overlay Color;22;1;[HDR];Create;True;0;0;0;True;0;False;0.8705882,0.8705882,0.8705882,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;562;983.5823,-2992.245;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;583;490.4599,-2034.1;Inherit;False;Property;_TopograpicalOverlayColor;Topograpical Overlay Color;27;1;[HDR];Create;True;0;0;0;True;0;False;0.8705882,0.8705882,0.8705882,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;584;589.9601,-2651.103;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;585;806.5052,-2765.254;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;564;2.256271,-2622.01;Inherit;False;Property;_FlowmapDistortOverlay;Flowmap Distort Overlay;33;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;565;218.2561,-2632.01;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;587;279.6364,-2745.188;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;586;2.781977,-2724.656;Inherit;False;Property;_TopograpicalDistortOverlay;Topograpical Distort Overlay;31;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;563;31.96532,-2487.47;Inherit;True;Property;_Flowmap;Flowmap;32;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Flowmap;0;0;False;0;False;-1;80cb9145056afff4997271b329ca1c2c;80cb9145056afff4997271b329ca1c2c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;154;-3487.25,827.3942;Inherit;True;Property;_ParallaxMap;Height Map;11;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;False;1;Parallax;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;165;-3718.092,1113.712;Inherit;True;Property;_DetailAlbedoMap;Detail Albedo X2;46;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.CommentaryNode;590;-5170.199,2175.339;Inherit;False;1877.917;1251.541;;14;604;603;602;601;600;599;598;597;596;595;594;593;592;591;Height Map;1,0.9924703,0,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;591;-4899.67,2614.758;Inherit;False;Property;_Parallax1;Height Scale;13;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;592;-4917.282,2412.21;Inherit;True;Property;_ParallaxMap1;Height Map;12;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;False;1;Parallax;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;593;-4551.067,2631.628;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;594;-4610.079,2296.642;Inherit;False;0;9;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;595;-4882.065,2894.036;Inherit;False;Tangent;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ParallaxOcclusionMappingNode;596;-4349.368,2403.256;Inherit;False;0;8;False;;16;False;;2;0.02;0;False;1,1;False;0,0;8;0;FLOAT2;0,0;False;1;SAMPLER2D;;False;7;SAMPLERSTATE;;False;2;FLOAT;0.02;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT2;0,0;False;6;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;597;-4049.833,2360.278;Inherit;False;UV_Main;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CustomExpressionNode;598;-4129.89,2747.365;Inherit;False;return _DetailAlbedoMap_ST.xy@;2;Create;1;True;In0;FLOAT;0;In;;Inherit;False;ReturnDetailAlbedo;True;False;0;;False;1;0;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;599;-4087.053,2602.08;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;600;-4627,2747.977;Inherit;False;0;165;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;601;-3933.968,2708.116;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode;602;-3735.228,2757.503;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TexturePropertyNode;603;-5148.124,2698.528;Inherit;True;Property;_DetailAlbedoMap1;Detail Albedo X2;45;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RegisterLocalVarNode;604;-4905.541,2775.148;Inherit;False;DetailAlbedoTexGroup;-1;True;1;0;SAMPLER2D;;False;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.FunctionNode;589;-2958.672,857.2418;Inherit;False;Bidirectional Parallax Mapping;-1;;147;ab457a4ccb6d8f745b63ef50e1417242;1,34,1;5;11;SAMPLER2D;0.0;False;32;SAMPLERSTATE;;False;10;FLOAT;0;False;9;FLOAT;0;False;25;INT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;607;-3251.294,877.7874;Inherit;False;Property;_Parallax3;Parallax Refence Plane;16;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;606;-3231.294,960.7874;Inherit;False;Property;_Parallax2;Parallax Iterations;14;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;596;1;592;0
WireConnection;596;7;592;1
WireConnection;596;2;593;0
WireConnection;596;3;595;0
WireConnection;599;0;596;0
WireConnection;599;1;594;0
...
WireConnection;589;11;154;0
WireConnection;589;32;154;1
WireConnection;589;10;607;0
WireConnection;589;9;155;0
WireConnection;589;25;606;0
ASEEND*/
//CHKSM=7F9745301643F29C4F72C455368F4DFE4823FD03