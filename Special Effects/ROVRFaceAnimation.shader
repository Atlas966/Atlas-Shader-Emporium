		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 appendResult62 = (float2(_TilingAndOffset.x , _TilingAndOffset.y));
				float2 appendResult63 = (float2(_TilingAndOffset.z , _TilingAndOffset.w));
				float2 texCoord64 = IN.ase_texcoord3.xy * appendResult62 + appendResult63;
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles70 = _Columns * _Rows;
				// Offsets for cols and rows of Flipbook Texture
				float fbcolsoffset70 = 1.0f / _Columns;
				float fbrowsoffset70 = 1.0f / _Rows;
				// Speed of animation
				float fbspeed70 = _Time[ 1 ] * _Speed;
				// UV Tiling (col and row offset)
				float2 fbtiling70 = float2(fbcolsoffset70, fbrowsoffset70);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
				float fbcurrenttileindex70 = round( fmod( fbspeed70 + _StartFrame, fbtotaltiles70) );
				fbcurrenttileindex70 += ( fbcurrenttileindex70 < 0) ? fbtotaltiles70 : 0;
				// Obtain Offset X coordinate from current tile linear index
				float fblinearindextox70 = round ( fmod ( fbcurrenttileindex70, _Columns ) );
				// Multiply Offset X by coloffset
				float fboffsetx70 = fblinearindextox70 * fbcolsoffset70;
				// Obtain Offset Y coordinate from current tile linear index
				float fblinearindextoy70 = round( fmod( ( fbcurrenttileindex70 - fblinearindextox70 ) / _Columns, _Rows ) );
				// Multiply Offset Y by rowoffset
				float fboffsety70 = fblinearindextoy70 * fbrowsoffset70;
				// UV Offset
				float2 fboffset70 = float2(fboffsetx70, fboffsety70);
				// Flipbook UV
				half2 fbuv70 = texCoord64 * fbtiling70 + fboffset70;
				// *** END Flipbook UV Animation vars ***
				
				half3 BakedAlbedo = 0;
				half3 BakedEmission = 0;
				half3 Color = ( tex2D( _Main, fbuv70 ) * _Color ).rgb;
				half Alpha = 1;
...
#pragma multi_compile_instancing#define ASE_SRP_VERSION -1
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( tex2D( _Main, fbuv70 ) * _Color ).rgb;
				float Alpha = 1;
				float AlphaClipThreshold = 0.5;
				float AlphaClipThresholdShadow = 0.5;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;5;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;7;True;12;all;0;False;True;1;1;False;;1;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;159.0475,-16.6445;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;ROVRFaceAnimation;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;7;True;12;all;0;False;True;1;1;False;;1;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;1;638843133391153191;  Blend;2;638843133401416519;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;Volumetrics;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-38.96764,-23.69679;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;13;-345.108,71.03384;Inherit;False;Property;_Color;Color;0;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-415.7571,-140.2126;Inherit;True;Property;_Main;Main;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;61;-1401.128,-296.3008;Inherit;False;Property;_TilingAndOffset;TilingAndOffset;2;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;62;-1177.128,-344.3008;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;63;-1193.128,-168.3008;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;64;-985.128,-360.3008;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;65;-921.1274,-248.3007;Inherit;False;Property;_Columns;Columns;3;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;66;-921.1274,-184.3008;Inherit;False;Property;_Rows;Rows;4;0;Create;True;0;0;0;False;0;False;8;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;67;-921.1274,-120.3008;Inherit;False;Property;_Speed;Speed;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCFlipBookUVAnimation;70;-700.4786,-141.3549;Inherit;False;1;0;6;0;FLOAT2;0,0;False;1;FLOAT;4;False;2;FLOAT;8;False;3;FLOAT;1;False;4;FLOAT;0;False;5;FLOAT;0;False;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;69;-943.0284,61.60947;Inherit;False;Property;_MaxFrame;Max Frame;7;0;Create;True;0;0;0;False;0;False;24;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;68;-946.3889,-41.13853;Inherit;False;Property;_StartFrame;Start Frame;6;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
WireConnection;70;4;68;0
ASEEND*/
//CHKSM=DA033B3505013AEE9BF83C9501FDA766E5E75FAC