...
Shader "AtlasShaders/Vertigo 2/Organic/Skin"
{
	Properties
	{
		...
		[NoScaleOffset] _ThicknessROcclusionGSSSMaskAOptional( "Thickness (R) Occlusion (G) SSS Mask (A, Optional)", 2D ) = "white" {}
		_ScatteringColor( "Scattering Color", Color ) = ( 0.3686275, 0.03921569, 0.01568628, 1 )
		_LightWrapping( "Light Wrapping", Range( 0, 0.5 ) ) = 0.085
		_ScatteringAmount( "Scattering Amount", Range( 0, 6 ) ) = 2
		_DiffuseSoftness( "Diffuse Softness", Range( 0, 6 ) ) = 0.9
		...
		[Toggle( _VERTEXPULSE_ON )] _VertexPulse( "Vertex Pulse", Float ) = 0
		_PulseAmplitude( "Pulse Amplitude", Float ) = 0.1
		_PulseFrequency( "Pulse Frequency", Float ) = 0.5
		_PulseVariation( "Pulse Variation", Float ) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _VERTEXPULSE_ON
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_68_0 = ( ( sin( ( ( ( _TimeParameters.x ) - ( sin( ( ase_positionWS.x / _PulseVariation ) ) + sin( ( ( ase_positionWS.y / _PulseVariation ) * 1.17352 ) ) + sin( ( ( ase_positionWS.z / _PulseVariation ) * 0.87236 ) ) ) ) * _PulseFrequency ) ) * 0.5 ) + 0.6 );
				float3 ase_normalWS = TransformObjectToWorldNormal( v.ase_normal );
				float lerpResult108 = lerp( 1.0 , v.ase_color.r , _PulseMaskingbyvertexcolorR);
				#ifdef _VERTEXPULSE_ON
				float3 staticSwitch79 = ( ( ( temp_output_68_0 * temp_output_68_0 ) * _PulseAmplitude ) * ase_normalWS * lerpResult108 );
				#else
				float3 staticSwitch79 = float3( 0,0,0 );
				#endif
				float3 VertexPulse74 = staticSwitch79;
				...
				#endif
				float3 vertexValue = VertexPulse74;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float4 Emission94 = ( tex2D( _EmissionMap, uv_EmissionMap ) * float4( _EmissionColor , 0.0 ) );
				
				float4 tex2DNode78 = tex2D( _MetallicSmoothness, uv_Albedo );
				float Metallic84 = ( tex2DNode78.r * _Metallic );
				
				float Smoothness85 = ( tex2DNode78.a * _Smoothness );
				...
				float3 Emission = Emission94.rgb;
#if 0
...
/*ASEBEGIN
Version=19908
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;98;-5088,-208;Inherit;False;3573.155;742.0103;;29;74;79;77;108;106;104;76;70;71;69;68;67;66;61;64;60;58;63;57;51;48;56;53;46;47;55;54;45;109;Vertex Pulse;0.8932958,0,1,1;0;0
Node;AmplifyShaderEditor.WorldPosInputsNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;45;-5056,-144;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleDivideOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;54;-4848,-48;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;55;-4848,64;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;47;-5056,0;Inherit;False;Property;_PulseVariation;Pulse Variation;18;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;46;-4848,-144;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;53;-4688,-48;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1.17352;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;56;-4688,64;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.87236;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;48;-4528,-144;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;51;-4528,80;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;57;-4528,304;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TimeNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;63;-4304,80;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;58;-4304,-144;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;60;-4080,-144;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;64;-4016,80;Inherit;False;Property;_PulseFrequency;Pulse Frequency;17;0;Create;True;0;0;0;False;0;False;0.5;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;61;-3856,-144;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;10.27;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;66;-3648,-144;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;67;-3472,-144;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;68;-3264,-144;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0.6;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;69;-3056,-144;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;71;-3040,80;Inherit;False;Property;_PulseAmplitude;Pulse Amplitude;16;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;76;-2800,80;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.VertexColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;104;-2592,80;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;106;-2720,256;Inherit;False;Property;_PulseMaskingbyvertexcolorR;Pulse Masking (by vertex color R);19;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;70;-2832,-144;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;108;-2400,80;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=620DFA9F6160290C21747C1A54BE277FB3ACA5AE